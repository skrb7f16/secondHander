...
public class MyRequests extends Application {
    MySqlOperations database;
    ArrayList<Requests> items;

    public MyRequests(MySqlOperations database) {
        this.database = database;
    }

    @Override
    public void start(Stage stage) throws Exception {
        items=database.getMyRequests();
        VBox root=new VBox();
        try {
        ...
        Label heading=new Label("Requests made by you");
